# Script descritpion ----
# simulation_2_extreme simulates data according to an "extreme" simulation setting. This
...
# simulation specifications. Our reasoning is as follows: The trade-off between data
# availability and parameter stability seems to be in favour of availability which yielded
# that the constant parameter model did not perform significantly worse compared to the
# tvem. We hence force the break not only to be in the "intercept" but specify completly
# different marketing characteristics (transition matrices). Whereas the break in the media
# reach is left unchanged. Concretly, we simply leaf the transition matrices as in the
# original setting (recall, that we have changed matrices in simulation_1_extreme...).
